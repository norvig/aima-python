...
clauses.append(expr("Sintoma(x, CambioLunar) & Sintoma(x, Asimetria) & Sintoma(x, Borde) & Sintoma(x, Color) & Sintoma(x, Diametro) & Sintoma(x, Evolucion) & Sintoma(x, Molestia) ==> Enfermedad(x, Melanoma)"))
clauses.append(expr("Sintoma(x, SurgeLunar) & Sintoma(x, Asimetria) & Sintoma(x, Borde) & Sintoma(x, Color) & Sintoma(x, Diametro) & Sintoma(x, Evolucion) & Sintoma(x, Molestia) ==> Enfermedad(x, Melanoma)"))
